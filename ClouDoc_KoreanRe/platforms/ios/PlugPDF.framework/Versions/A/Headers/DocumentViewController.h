...
typedef NS_OPTIONS(NSUInteger, PlugPDFDocumentNavigationBarMode) {
    ...
    // PlugPDFDocumentNavigationBarModerAnnotPopUP
    PlugPDFDocumentNavigationBarModeAnnots       = 3     // The navigation bar displays the annotation's setting items for the edit annotations.
};
...
typedef NS_OPTIONS(NSUInteger, PlugPDFDocumentMenuItem) {
    ...
    PlugPDFDocumentMenuItemAnnotationPopUp          = 307,    // Annotation PopUp
    PlugPDFDocumentMenuItemCircle                   = 308,    // Circle annotation
    PlugPDFDocumentMenuItemSquare                   = 309,    // Square annotation
...
/**
 * Enables/Disables the note annotation popup controller.
 * The default value is YES.
 *
 */
@property (nonatomic) BOOL enableAnnotNotePopup;
...
/**
 * Enables/Disables the thumbnail mutiple image indicator.
 *
 */
@property (nonatomic) BOOL enableThumbnailMultiplePagePreview;
...
/**
 * toolbar's back button icon image.
 *
 */
@property (nonatomic) UIImage* backButtonIcon;

/**
 * toolbar's next button icon image.
 *
 */
@property (nonatomic) UIImage* nextButtonIcon;

/**
 * toolbar's next button icon image.
 *
 */
@property (nonatomic) BOOL enablePageIndicatorButton;

/**
 *
 *UInavigationBarHeight.
 *
 */
 ...
 *
 */
@property (nonatomic) PlugPDFTool toolOption;
...
/**
 * Enables/Disables tool bar color setting instead of setting uiimage in the top bar and bottom bar.
 *
 *
 */
@property (nonatomic) BOOL enableToolBarColor;
 ...
 *
 * @param toolbarcolor
 *          The navigation bar UIColor.
 *
 */
- (void)setNavigationTopBarColor: (UIColor*)toolbarcolor;

/**
 * Sets the tool bar color.
 *
 * @param toolbarcolor
 *          The toolbar bar UIColor.
 *
 */
- (void)setToolBarColor: (UIColor*)topbarcolor;
...
- (void)setPageViewBackgroundColor:(UIColor*)pageViewColor;
...
/**
 * Sets the multiple thumbnail view's visibility on the page slider.
 * This method shouldn't be called directly since it is intended to be a private function.
 *
 * @param hidden
 *          YES: hides the multiple thumbnail; NO: displays the thumbnail
 *
 */
- (void)setMultipleThumbnailHiddenPrivate: (BOOL)hidden;

- (void)setThumbnailPage: (NSInteger)thumbnailPageCount;

- (void)setThumbnailPages: (NSInteger)pageIdx pageCount: (NSInteger)pageCount;

- (void)setThumbnailViewCount: (NSInteger)thumbnailPageCount;
/**
...
/**
 * Sets the page preview's rect.
 *
 * @param size
 *          The rect of page preview.
 */
- (void)setPagePreviewRect: (CGRect)rect;

/**
 * Sets the pageindicator point.
 *
 * @param size
 *          The point of pageindicator.
 */
- (void)setPageIndicatorPoint: (CGPoint)point;
...
/**
 *The sum of pdf page size.
 *
 */
@property (nonatomic) CGSize sumPageSize;

/**
 * Array of the pdf page size.
 *
 */
@property (nonatomic, strong) NSMutableArray *pageSize;
/**
 ...
 *
 * @param mode
 *          The possible values are available in the PlugPDFDocumentEraserType/ enumeration.
 *
 */
- (void)setEraserType:(PlugPDFDocumentEraserType)eraserType;
 ...
 */
@property (nonatomic) UIColor* thumbnailbackground;
...
/**
 * Sets the size of the drag eraser.
 *
 * @param size
 *          The size of the drag eraser width.
 *
 */
- (void)setDragEraserSize: (CGFloat)size;
...
/**
 * Sets the pageindicator with page move button in the toolbar.
 *
 *  @param toolBarIndicator
 *          default is No.
 */

- (void)setToolBarPageIndicatorButton: (BOOL)toolBarIndicator;
...
/**
 * Sets the child element option in the OutlineEditViewController.
 *
 * @param outlineChildElement
 *          YES: show the child element; NO: No show the child element.
 *
 */
- (void)setOutlineChildElement: (BOOL)outlineChildElement;
...
- (void)setShapeWidth: (CGFloat)width;
...
/**
* Circle annotation's transparent.
*/
@property (nonatomic) Boolean circleAnnotTransparent;

/**
 * Circle annotation's Opacity.
 */
@property (nonatomic) CGFloat circleAnnotOpacity;
...
/**
 * Square annotation's transparent.
 *
 */
@property (nonatomic) Boolean squareAnnotTransparent;

/**
 * Square annotation's Opacity.
 *
 */
@property (nonatomic) CGFloat squareAnnotOpacity;

/**
 * The size of navigation's item.
 *
 */
@property (nonatomic) CGSize navigationItemSize;

#pragma mark - bookmark title

/**
 * The bookmark's title.
 *
 */
@property(nonatomic) NSString* bookmarkTitle;

#pragma mark - path
/**
 * Returns a PDF path, If you used a below method.
