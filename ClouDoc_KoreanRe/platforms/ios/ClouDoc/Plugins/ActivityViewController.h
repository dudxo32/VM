...
@interface ActivityViewController : UIViewController < UIWebViewDelegate , UIGestureRecognizerDelegate> {
ServerCmd					*m_serverCmd;}

@property (nonatomic, strong) IBOutlet UIWebView* webView;


@property (nonatomic, unsafe_unretained)id <ActivityViewDelegate> delegate;
