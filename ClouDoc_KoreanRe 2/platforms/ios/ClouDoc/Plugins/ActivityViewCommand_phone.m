...
#import "ActivityViewCommand_phone.h"
#import <Cordova/CDVViewController.h>

@implementation ActivityViewCommand_phone
...
{	
...
#else
        self.ActView = [[[ActivityViewController_phone alloc] initWithScale:NO] autorelease];
#endif
    ...
    {
        ActView.view.frame = CGRectMake(0, 0, 640, 960);
        
    }
    else
    {
        ActView.view.frame = CGRectMake(0, 0, 960, 640);
    }
