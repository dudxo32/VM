...
{	
    ...
    NSString *file_open = (NSString*) [arguments objectAtIndex:2];
    
    NSLog(@"file open is %@", file_open);
    
    NSURL   *pUrl = [NSURL fileURLWithPath:url];
    NSLog(@"pUrl is %@", pUrl);
    
  /*
  /*다운로드 후 다른앱 열기 연동 테스트
    ...
    [docController presentOpenInMenuFromRect:CGRectZero inView:self.viewController animated:YES];
   ...
   */
    ...
    [self.childBrowser loadURL:url file_open:file_open];
